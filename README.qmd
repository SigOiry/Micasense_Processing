...
meta <-data.frame(
  ...
  Focal_Plane_Resolution_X = NA,
  Focal_Plane_Resolution_Y = NA
)
...
for (i in 1:nrow(image_df)){
  ...
  meta$Focal_Plane_Resolution_X[i]<-exif$FocalPlaneXResolution
  meta$Focal_Plane_Resolution_Y[i]<-exif$FocalPlaneYResolution
