...
The dual-MX camera have a spectral resolution of 10 bands, ranging from the blue (444nm) to the NIR (840nm). The following code is used to find the path of each individual image, to identify each band of each image and to extract all the metadata that will be needed.
