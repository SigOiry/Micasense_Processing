...
**WORK IN PROGRESS (last update : `r Sys.Date()`)**
...
At this step, we gonna apply at once vignetting, row gradient and dark level correction. The dark level correction is aimed at addressing the camera sensor's inherent noise and ensuring the baseline level of the image data is accurately set, enhancing image quality and accuracy for analysis.
