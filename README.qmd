...
That's exactly what the `Coordinate_panel()` function does.
It takes an image as input and provides the coordinates of four possible positions of the calibration panel as output.
