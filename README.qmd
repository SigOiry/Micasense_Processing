...
It appears there's a disparity in the amount of light captured at the top of the sensor versus what's recorded at the bottom. Within the `XMP:RadiometricCalibration` tag of MicaSense images' metadata, one can find all the necessary information to correct for this row gradient effect.
