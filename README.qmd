...
To overcome this issues I use `Reticulate` to create a link between an R environment and a Python environment. This allows me to have chunks of code in both R and Python and to be able to pass variables between these two languages.
