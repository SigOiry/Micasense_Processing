...
def Undistort_Ref():
  new_cam_mat, _ = cv2.getOptimalNewCameraMatrix(r.cam_mat, r.dist_coeffs, (r.w, r.h), 1, (r.w, r.h))
  image = cv2.imread('Output/Reflectance/R_IMG_0688_9.tif',cv2.IMREAD_UNCHANGED)
  image_corrige = cv2.undistort(image,r.cam_mat,r.dist_coeffs,None,new_cam_mat)
  cv2.imwrite('Output/undist/R_IMG_0688_9.tif', image_corrige)
```
