...
The transfer function of radiance to reflectance for the each band is:
...
$F_i$ is the reflectance calibration factor for band i
$P_i$ is the reflectance of the CRP for the ith band (from the calibration data of the panel provided by MicaSense)
$avg(L_i)$ is the average value of the radiance for the pixels inside the panel for band i
...
test<-py$undistortedReflectance
